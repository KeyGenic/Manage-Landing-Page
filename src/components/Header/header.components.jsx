...
export const Header = () => {
    ...
    return(
        ...
        {isToggle === false?  <Hamburger props = {toggle} /> : null}
        {isToggle === true? <CloseToggle props = {toggle} /> : null}
        ...
        <svg class = 'small-pill' xmlns="http://www.w3.org/2000/svg" width="500" height="814"><rect className = "sm-pill" width="300" height="700" x="700" y="-250" fill="red" fill-rule="evenodd" rx="200" transform="rotate(45 718.814 -291.157)"/></svg>
        </div> 
    )
}