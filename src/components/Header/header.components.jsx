...
import { ReactComponent as Manage } from '../../Assets/illustration-intro.svg'
import { GetStarted } from "../cta-btn/cta-btn.components";
import { Hamburger } from "../Hamburger/hamburger.components";
import '../../color-variables/color-var.styles.scss'
import { CloseToggle } from "../close-toggle/close-toggle.components";
import { MobileMenu } from "../mobile-menu/mobile-menu.components";
import { DesktopNav } from "../desktop-nav/desktop-nav.components";
export const Header = () => {
    ...
    return(
        ...
        <svg class = 'small-pill' xmlns="http://www.w3.org/2000/svg" width="500" height="814"><rect className = "sm-pill" width="300" height="500" x="700" y="-60" fill="red" fill-rule="evenodd" rx="218" transform="rotate(45 718.814 -291.157)"/></svg>
        </div> 
    )
}